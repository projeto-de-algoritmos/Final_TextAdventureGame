...
public class Principal {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Area sala2 = new Area ("Quarto 2", "Descrição Sala 2");
        Area sala3 = new Area ("Quarto 1", "Descrição Sala 3");
        AreaIluminada sala4 = new AreaIluminada ("Sala Visita", "Descrição Sala 4", false, "A sala está muita escura para enxergar alguma coisa. Alguma fonte de luz poderia ajudar...");
        Area sala5 = new Area ("Close 1", "Descrição Sala 5");
        Area sala6 = new Area ("Banheiro 1", "Descrição Sala 6");
        Area sala7 = new Area ("Fundos da Biblioteca", "Descrição Sala 7");
        AreaIluminada sala8 = new AreaIluminada ("Banheiro 2", "Descrição Sala 8", false, "A sala está muita escura para enxergar alguma coisa. Alguma fonte de luz poderia ajudar...");
        Area sala9 = new Area ("Salão Central", "Descrição Sala 9");
        Area sala10 = new Area ("Banheiro 7", "Descrição Sala 10");
        Area sala11 = new Area ("Corredor 1", "Descrição Sala 11");
        AreaIluminada sala12 = new AreaIluminada ("Biblioteca - Área Principal", "Descrição Sala 12", false, "A sala está muita escura para enxergar alguma coisa. Alguma fonte de luz poderia ajudar...");
        Area sala13 = new Area ("Biblioteca - Área de Leitura", "Descrição Sala 13");
        Area sala14 = new Area ("Banheiro 5", "Descrição Sala 14");
        Area sala15 = new Area ("Biblioteca - Sessão Reservada", "Descrição Sala 15");
        Area sala16 = new Area ("Quarto 4", "Descrição Sala 16");
        AreaIluminada sala17 = new AreaIluminada ("Banheiro 4", "Descrição Sala 17", false, "A sala está muita escura para enxergar alguma coisa. Alguma fonte de luz poderia ajudar...");
        Area sala18 = new Area ("Quarto 5", "Descrição Sala 18");
        Area sala19 = new Area ("Quarto 3", "Descrição Sala 19");
        Area sala20 = new Area ("Banheiro 3", "Descrição Sala 20");
        Area sala21 = new Area ("Corredor Anexo 2", "Descrição Sala 21");
        Area sala22 = new Area ("Sala de Jantar", "Descrição Sala 22");
        Area sala23 = new Area ("Área de Serviço", "Descrição Sala 23");
        Area sala24 = new Area ("Cozinha", "Descrição Sala 24");
        Area sala25 = new Area ("Banheiro 6", "Descrição Sala 25");
        Area sala26 = new Area ("Despensa 2", "Descrição Sala 26");
        AreaIluminada sala27 = new AreaIluminada ("Dispensa 1", "Descrição Sala 27", false, "A sala está muita escura para identificar qualquer coisa aqui.");
        Area sala28 = new Area ("Corredor 3", "Descrição Sala 28");
        AreaIluminada sala29 = new AreaIluminada ("Sótão", "Descrição Sala 29", false, "A sala está muita escura para enxergar alguma coisa. Alguma fonte de luz poderia ajudar...");
        AreaIluminada sala30 = new AreaIluminada ("Bunker", "Descrição Sala 30", false, "A sala está muita escura para enxergar alguma coisa. Alguma fonte de luz poderia ajudar...");
        AreaIluminada sala31 = new AreaIluminada ("Jardim dos Fundos", "Descrição Sala 31", false, "A sala está muita escura para enxergar alguma coisa. Alguma fonte de luz poderia ajudar...");
